import itertools, math, bounds, warnings, sys
...
def doloop_genus2(data_pts, sextic_coeffs, all_known_x, cumulative_stats):
    ...
    while True:
        ...
        # x_b: base point x-coord in the shifted system (GF(p) element in FF mode)
        x_b_for_aug = base_pts[0][0] if base_pts else None

        # shifted_coeffs: coefficients of shifted_G_poly for fiber augment
        shifted_coeffs_for_aug = list(shifted_G_poly.list())
